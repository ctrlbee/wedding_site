...
var popupText1 = "Check-in at the front desk, grab your room key and put on your bathing suit. Cruise around the property, take a dip in the pool, grab a drink, have a bite, jump in the ocean. Go nuts, your officially on vacation now. <br> <br> We’ll also be organizing an East-Coast-v-West-Coast game of touch football on the beach. Kick off will be at the De Cortez beach at 1pm.";
var popupText2 = "7pm to 10pm: Please join us at the Palapa Fiesta area of the hotel located next to the Infinity Pool overlooking the Playa Tortugas Beach. We will be providing dinner and kicking off the weekend with introductions, announcements and tequila shots.";
var popupText3 = "After dinner, we will head down to the Playa Tortugas Beach to relax and take in the waves crashing on the shore.";
var popupText4 = "Enjoy all day at the pool and beach. We’ll have our music playing at the Delfines pool that includes a swim up bar and hot tub.";
var popupText5 = "We hope you’ll be having a blast in the sun all day, but we’ll kindly request you wrap up your daytime festivities around 4pm-ish so you can swing back to your guestroom to get ready for the main event of the weekend.";
var popupText6 = "6pm to 7pm: We’ll be exchanging our vows at the hotel’s Chapel located just near the main entrance of the hotel. Please arrive promptly by 6pm. Maracas will be provided. We'll snap a few group photo outside the chapel after we seal the deal.";
...
var popupText8 = "8pm to 11pm: This will be the night to remember in 2014. Reception party is on the De Cortez Restaurant Deck overlooking the ocean. Legendary Philly DJ MIKE ALBA, arguably one of the best all around DJs to ever grace the decks, will rock the house while leading us through the night's events!";
var popupText9 = "11pm to ??: The party on the deck will be winding down, but doesn’t mean we it's time for bed just yet. There will be a beach bonfire after party with s’mores and coolers of beers on the beach under the stars. Music, chairs and beach blankets will be provided, just bring your handsome self.";
var popupText10 = "9am to 12pm: There’s no better way to beat a hangover than a hot brunch spread with mimosas. Brunch will be set up at the Delfines Pool area right outside your room.";
